...
import com.security.jwt.filter.JwtLoginAuthFilter;
import com.security.jwt.filter.JwtPreAuthFilter;
import com.security.jwt.handler.UnAuthorizedEntryPoint;
import com.security.jwt.handler.ZTCLogoutSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors()
                ...
                .logoutSuccessHandler(new ZTCLogoutSuccessHandler())
                .and()
                // 添加到过滤链中
